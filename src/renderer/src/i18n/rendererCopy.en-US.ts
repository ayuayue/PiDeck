...
export const enUS: Record<TranslationKey, string> = {
	...
	"common.batchManage": "Batch Manage",
	...
	"config.models.batchActionLabel": "Select an action",
	"config.models.batchAction.delete": "Batch Delete",
	"config.models.batchAction.export": "Batch Export",
	"config.models.batchExecute": "Execute",
	...
	"config.models.transfer.exportToClipboard": "Export to Clipboard",
	"config.models.transfer.exportToFile": "Export to File",
	...
	// Update channel (badge + switch wizard, spec §5): confirm area copy includes data-mode notice
	"settings.channelBadgeStable": "Stable",
	"settings.channelBadgeDev": "Dev",
	"settings.channelSwitchToDev": "Switch to Dev",
	"settings.channelSwitchToStable": "Switch back to Stable",
	"settings.channelSwitchDialogTitle": "Switch Update Channel",
	"settings.channelSwitchQuerying": "Checking the latest version for the target channel…",
	"settings.channelSwitchTargetVersion": "Target version: v{version}",
	"settings.channelSwitchNotes": "Release notes",
	"settings.channelSwitchDataModeNotice": "After installing, you'll be asked to choose a data mode on first launch",
	"settings.channelSwitchDownload": "Download",
	"settings.channelSwitchInstallNow": "Install Now",
	"settings.channelSwitchOpenReleasePage": "Open Release Page",
	"settings.channelSwitchError": "Switch failed: {error}",
	// Data environment (dev first-launch data mode choice + import wizard + marker mismatch warning, spec §5/§6); option copy verbatim from spec §5
	"dataMode.dialogTitle": "Choose Data Mode",
	"dataMode.dialogDesc": "Choose how the Dev build uses its data directory. You can change this later in Settings → Dev.",
	"dataMode.sharedTitle": "Share with Stable",
	"dataMode.sharedDesc": "Share the same data directory with the Stable build and switch channels seamlessly. New settings written by Dev may not be recognized by Stable yet.",
	"dataMode.channelDevTitle": "Independent Directory",
	"dataMode.channelDevDesc": "Use an independent data directory. On first use you can import a snapshot from the Stable build; afterwards, sessions, settings and other changes made in Dev do not sync back to Stable automatically — bring them over yourself.",
	"dataMode.importSnapshot": "Import Data from Stable",
	"dataMode.importSnapshotDesc": "The import finishes before the restart. Keep the app open meanwhile.",
	"dataMode.importEstimating": "Estimating data size to migrate…",
	"dataMode.importPreviewSize": "Estimated data to migrate: {size}",
	"dataMode.importStart": "Start Import",
	"dataMode.importRunning": "Importing…",
	"dataMode.importCopying": "Importing: {item}",
	"dataMode.importDone": "Import complete. The app will restart…",
	"dataMode.importCancelled": "Import cancelled. Copied content is preserved and you can import again.",
	"dataMode.importSkip": "Skip Import",
	"dataMode.importUnavailable": "Data import is unavailable in this environment",
	"dataMode.importError": "Import failed. Please try again.",
	"dataMode.modeChangeFailed": "Operation failed. Please try again.",
	"dataMode.mismatchTitle": "Data Directory Does Not Match This Channel",
	"dataMode.mismatchDesc": "The current data directory belongs to the other channel's data mode. Continuing may mix data between the two channels.",
	"dataMode.mismatchContinue": "Continue Anyway",
	"dataMode.mismatchQuit": "Quit",
	"settings.updateSourceDevLocked": "Dev builds always use the GitHub update source (prerelease channel)",
	"settings.dataEnvSectionTitle": "Data Environment",
	"settings.dataEnvCurrentMode": "Current Data Mode",
	"settings.dataEnvSwitchButton": "Switch Data Mode",
	"settings.dataEnvSwitchConfirmDesc": "The change takes effect after the app restarts",
