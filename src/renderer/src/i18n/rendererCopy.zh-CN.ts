...
export const zhCN = {
  ...
  "app.fileLinkCannotResolve": "无法打开文件链接：相对路径缺少基准目录（无活动 Agent 工作目录/未打开项目）：{path}",
...
"config.emptyExtensions": "暂无已安装扩展。",
  ...
  "update.availableInSettings": "发现新版本，可在此检测并下载更新。",
  ...
  "update.skipVersionHint": "不再提醒此版本，仍可在设置中手动检测。",
