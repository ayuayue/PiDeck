...
const zhCN = {
  ...
  "config.recommendedPackages": "推荐扩展包",
	"config.builtinFeatures": "内置功能",
	"config.builtinGoal": "Goal",
	"config.builtinGoalDescription": "设置任务目标，Agent 空闲时自动续接直到完成。",
	"config.goalEnabledToast": "Goal 功能已启用",
	"config.goalDisabledToast": "Goal 功能已禁用",
...
const enUS: Record<TranslationKey, string> = {
  ...
  "config.extensionRestartHint": "Create or restart agents after uninstalling.",
	"config.builtinFeatures": "Built-in",
	"config.builtinGoal": "Goal",
	"config.builtinGoalDescription": "Set task goals for the agent, auto-resume when idle until completion.",
	"config.goalEnabledToast": "Goal enabled",
	"config.goalDisabledToast": "Goal disabled",
