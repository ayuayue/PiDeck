...
const zhCN = {
  ...
  "config.extensionConflict": "内置扩展 {builtIn} 与 {thirdParty} 冲突，已自动关闭内置版，推荐卸载三方扩展使用内置替代",
  "config.removeBuiltIn": "从自动部署中移除（文件仍保留）",
  "config.restoreBuiltIn": "恢复自动部署",
...
"config.emptyExtensions": "No installed extensions.",
  "config.extensionConflict": "Built-in {builtIn} conflicts with third-party {thirdParty}, auto-closed built-in. Recommend removing third-party extension and using the built-in one.",
  "config.removeBuiltIn": "Remove from auto-deploy (files kept)",
  "config.restoreBuiltIn": "Restore auto-deploy",
