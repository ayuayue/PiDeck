...
const zhCN = {
  ...
  "sessionRef.fullContext": "全部上下文",
  "sessionRef.selectMessages": "选择消息",
  "sessionRef.messageCount": "共 {count} 条消息",
  "sessionRef.selectedCount": "已选 {count}/{total} 条",
  "sessionRef.insertReference": "插入引用",
...
const enUS: Record<TranslationKey, string> = {
  ...
  "sessionRef.fullContext": "Full Context",
  "sessionRef.selectMessages": "Select Messages",
  "sessionRef.messageCount": "{count} messages",
  "sessionRef.selectedCount": "{count}/{total} selected",
  "sessionRef.insertReference": "Insert Reference",
