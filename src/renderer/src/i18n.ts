...
const zhCN = {
  ...
  "app.steerTag": "加入当前回合",
  "app.followUpTag": "排队到下一轮",
  "app.directTag": "已提交",
  "app.queuedMessagesLabel": "待发送消息",
  "app.queuedImageMessage": "图片消息",
  "app.queuedImageCount": "{count} 张图片",
  "app.queuedSending": "发送中",
  "app.queuedFailed": "发送失败",
  "app.queuedUnknownShort": "结果未知",
  "app.queuedUnknown": "消息已提交，但未收到确认。为避免重复发送，已禁用重试、编辑和取消；请先检查当前会话，确认后可移除提示。",
  "app.queuedAcknowledge": "已检查，移除",
  "app.queuedRetry": "重试",
  "app.retractEdit": "撤回编辑",
  "app.retractCancel": "取消",
...
const enUS: Record<TranslationKey, string> = {
  ...
  "app.steerTag": "Add to turn",
  "app.followUpTag": "Queue next",
  "app.directTag": "Submitted",
  "app.queuedMessagesLabel": "Pending messages",
  "app.queuedImageMessage": "Image message",
  "app.queuedImageCount": "{count} image(s)",
  "app.queuedSending": "Sending",
  "app.queuedFailed": "Failed",
  "app.queuedUnknownShort": "Unknown",
  "app.queuedUnknown": "The message was submitted but no confirmation arrived. Retry, edit, and cancel are disabled to prevent duplicate delivery; check the current session, then dismiss this notice.",
  "app.queuedAcknowledge": "Checked · Dismiss",
  "app.queuedRetry": "Retry",
  "app.retractEdit": "Edit",
  "app.retractCancel": "Cancel",
