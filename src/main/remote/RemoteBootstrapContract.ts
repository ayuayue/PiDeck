 ...
 *   (regular file, no symlink, POSIX owner and mode, sha256 and byte count), fsyncs the files and
 *   best-effort the directories, then renames the staging directory to
