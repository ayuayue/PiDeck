...
const testCases = [
 ...
 {
  name: "grep nul 不是重定向",
  input: "grep nul file.txt",
  expected: "grep nul file.txt",
 },
 { name: "echo nul 不含重定向", input: "echo nul", expected: "echo nul" },
 {
  name: "echo null value",
  input: "echo null value",
  expected: "echo null value",
 },
 // ---- stdout 覆盖 ----
 {
  name: "> nul",
  input: "echo hello > nul",
 ...
 {
  name: "1> nul",
  input: "echo hello 1> nul",
  expected: "echo hello 1>/dev/null",
 },
 {
  name: "2> nul",
  input: "echo hello 2> nul",
  expected: "echo hello 2>/dev/null",
 },
 {
  name: "1>> nul",
  input: "echo hello 1>> nul",
 ...
 {
  name: "两个 > nul",
  input: "echo a > nul && echo b > nul",
  expected: "echo a >/dev/null && echo b >/dev/null",
 },
 // ---- 控制字符边界 ----
 {
  name: "管道后",
  input: "echo hello > nul|cat",
  expected: "echo hello >/dev/null|cat",
 },
 {
  name: "分号后",
  input: "echo hello > nul;echo done",
  expected: "echo hello >/dev/null;echo done",
 },
 {
  name: "括号后",
  input: "echo hello > nul(extra",
  expected: "echo hello >/dev/null(extra",
 },
 // ---- 裸重定向 ----
 ...
 {
  name: "> nul.txt",
  input: "echo data > nul.txt",
  expected: "echo data > nul.txt",
 },
 {
  name: "> nul-backup",
  input: "echo data > nul-backup",
  expected: "echo data > nul-backup",
 },
 {
  name: "> nul_suffix",
  input: "echo data > nul_suffix",
  expected: "echo data > nul_suffix",
 },
 {
  name: "> null_file",
  input: "echo data > null_file",
  expected: "echo data > null_file",
 },
 // ---- 不应重写：引号内 ----
 {
  name: "双引号内 > nul",
  input: 'echo "foo > nul bar"',
  expected: 'echo "foo > nul bar"',
 },
 {
  name: "双引号内嵌套单引号",
  input: "echo \"foo 'bar > nul baz'\"",
  expected: "echo \"foo 'bar > nul baz'\"",
 },
 {
  name: "单引号内 > nul",
  input: "echo 'foo > nul bar'",
 ...
 // ---- 混合引号 ----
 {
  name: "混合单双引号外重写",
  input: "echo 'a' \"b\" > nul",
  expected: "echo 'a' \"b\" >/dev/null",
 },
 {
  name: "单引号内含双引号不重写",
  input: "echo 'a \"b\" c' > nul",
  expected: "echo 'a \"b\" c' >/dev/null",
 },
 // ---- 2>&1 组合 ----
 {
  name: "2>&1 > nul",
  input: "cmd 2>&1 > nul",
  expected: "cmd 2>&1 >/dev/null",
 },
 ...
 // ---- 转义引号 ----
 {
  name: "转义双引号外重写",
  input: 'echo \\"foo > nul bar\\"',
  expected: 'echo \\"foo >/dev/null bar\\"',
 },
 {
  name: "双引号内转义双引号不重写",
  input: 'echo "foo \\"bar > nul baz"',
