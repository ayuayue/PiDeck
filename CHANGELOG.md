...
### 🙏 Thanks
- Thanks to **@TheMapleBin** for the path-linkification text-loss fix (#274 / #276), **@525300887039** for reporting the Chinese-slash misdetection (#277), and **@cmyk-xing** for the looser provider names, the DSH add-provider form and the narrow-window layout work (#268).
